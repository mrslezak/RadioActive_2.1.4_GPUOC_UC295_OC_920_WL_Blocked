...
clear
cd /home/user/radioactive_GPUOC/
...
# Paths
KERNEL_DIR=`pwd`
ZIMAGE_DIR="/home/user/radioactive_GPUOC/out-clang12/arch/arm64/boot/"

# Kernel Details
VER="-2.1.4"

# Vars
BASE_AK_VER="radioactive-Op8-Series-OOS-GPUOC"
...
cd /home/user/radioactive_GPUOC/out-clang12/arch/arm64/boot/
